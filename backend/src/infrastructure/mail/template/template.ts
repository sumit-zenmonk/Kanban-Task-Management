export const welcomeEmailTemplate = (name: string) => `
  <html>
    <body>
      ...
      <p>Start your journey by checking out your dashboard: <a href="http://localhost:3000/">Dashboard</a></p>
...
export const teamMemberAddedTemplate = (team_name: string, team_uuid: string) => `
  <html>
    <body>
      ...
      <p>Check out your team details here: <a href="http://localhost:3000/team/${team_uuid}">Team Details</a></p>
    </body>
  </html>
`;
...
export const taskAssignmentTemplate = (task_name: string, project_uuid: string, team_uuid: string) => `
  <html>
    <body>
      ...
      <p><a href="http://localhost:3000/team/${team_uuid}/project/${project_uuid}">Task Details</a></p>
    </body>
  </html>
`;